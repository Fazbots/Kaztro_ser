...
module.exports = {
    ...
    SESSION: process.env.INRL_CODE === undefined ? '' : process.env.INRL_CODE,
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ fasweeh*' : process.env.ALL_CAPTION,
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'inrl' : process.env.DEPLOYER,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'fasweeh' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '917025099161@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ fasweeh ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    INRL: process.env.ALIVE_BUTTON === undefined ? 'sᴇᴅ/ʜᴀᴘᴘʏ' : process.env.ALIVE_BUTTON,   
    ...
    inrl: process.env.GIT_BUTTON === undefined ? 'ʏᴇs/ɴᴏ' : process.env.GIT_BUTTON,   
    SAID: process.env.BGM_DURATION === undefined ? '39999600' : process.env.BGM_DURATION,
    BLOCKMSG: process.env.BLOCK_MESSAGE === undefined ? 'default' : process.env.BLOCK_MESSAGE,
    UNBLOCKMSG: process.env.UNBLOCK_MESSAGE === undefined ? 'default' : process.env.UNBLOCK_MESSAGE,
    SED: process.env.SED_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ fasweeh*' : process.env.SED_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'fasweeh' : process.env.BOT_NAME,
    ...
    BC: process.env.AUDIO_CAPTION === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝fasweeh࿐⁩' : process.env.AUDIO_CAPTION,
    ...
    SUDO: process.env.SUDO === undefined ? '917025099161,0' : process.env.SUDO,
    DEBUG: DEBUG,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    BOTCREATOR: "fasweeh",
    MAHN: "91907279058a7,0",
